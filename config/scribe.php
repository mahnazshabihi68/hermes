...
return [
     ...
     */
    'description' => config('app.name') . ' API Docs',
...
//                        'app.env' => 'documentation',
     ...
     */
    'intro_text' => '<aside>The Greek god <b>Hermes</b> (the Roman Mercury) was the god of translators and interpreters. He was the most clever of the Olympian gods, and served as messenger for all the other gods. He ruled over wealth, good fortune, commerce, fertility, and thievery. Because of his speed, he was sometimes considered a god of winds.</aside>',
